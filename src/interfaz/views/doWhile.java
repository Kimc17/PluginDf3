...
public class doWhile {
	...
	public doWhile(Canvas canvas, int x1, int y1, NodoSimple statement) {
		this.canvas = canvas;
		this.x = x1;
		this.y = y1;
		...
		canvas.addPaintListener(new PaintListener() {
			...
			public void paintControl(PaintEvent e) {
				...
				e.gc.drawString(statement.getBody(), x-20, y+45);
				...
				e.gc.drawString(statement.getExpresion(), x-30, y+25);
